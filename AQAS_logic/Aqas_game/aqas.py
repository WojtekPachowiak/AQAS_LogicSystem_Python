...
class AQAS_Solver:
    ...
    def s_transform(gamma_delta : dict[str:list, str:list]) -> type_sqnt:
        ...
        while True:
            ...
            #jeżeli nie udało zastosować się jakiejkolwiek reguły na którymkolwiek sekwnecie => zakończ (S-transformacja zakończona pomyślnie)
            #TODO: czy obecny warunek zakończenia pętli jest najlepszy? Może lepiej sprawdzać, czy każdy element każdego sekwentu jest literałem? (jego type to str)
            #TODO: sprawdzić czy "!=" nie spowoduje bugów - nie wiem jak Python sprawdza identyczność list, więc nie wiem czego oczekiwać
