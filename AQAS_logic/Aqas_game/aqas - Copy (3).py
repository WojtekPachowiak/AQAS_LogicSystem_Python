...
class AQAS_Solver:
    ...
    def _R_alpha_or_L_beta(gamma_or_delta : list, rule_type : str) -> list[list]:
        ...
        desired_form_found = False
        sequents = []
        sequents.append(gamma_or_delta)
        for sqnt in sequents:
            for form in sqnt:
                form, alpha_form_found = find_desired_form_and_process_it(form, rule_type)
